...
import AddBox from "./dynamicallyAddBox/addBox";
import FileUploader from "./fileUploader/uploader";

import CategoryBox from "./autoComplete/categories";
  ...
  <StyledBox>
    <StyledStackForContent spacing={1}>
      <Stack spacing={8}>
        ...
        <Stack direction="row" spacing={4}>
          <StyledBoxForTextField style={{ width: "15%" }}>
            <Typography variant="body1">Search tags</Typography>
          </StyledBoxForTextField>
          <StyledTextFieldTheme
...
const step2Content = (
  <StyledBox>
    <StyledStackForContent spacing={1}>
      <StyledHeader variant="h4">Scope & Pricing</StyledHeader>
...
const step3Content = (
  <StyledBox>
    <StyledHeader variant="h4">Description</StyledHeader>
    <Divider style={{ marginTop: 20, marginBottom: 20 }} />
    <StyledStackForContent
      spacing={1}
  ...
  <StyledBox>
    <StyledStackForContent spacing={1}>
      <Stack spacing={1}>
        ...
        <Divider>
          <Typography variant="caption">YOUR QUESTIONS</Typography>
        </Divider>
      </Stack>
