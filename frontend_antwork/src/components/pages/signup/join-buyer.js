...
const RegisterPage = (props) => {
  ...
  const [ checkBehalf, setCheckBehalf ] = useState(null)
          ...
          <form onSubmit={handleSubmit(formsubmit)} >
            <div style={{ textAlign: "center" }}>
              ...
              <Controller 
                ...
                name="behalf"
                rules={{
                  required : { value : true, message : "กรุณาเลือกประเภท"},
                }}
                render={({field})=>(
                  <StyledTextFieldTheme
                    {...field}
                    ...
                    variant="filled"
                    fullWidth
                    helperText={ errors && errors.behalf && errors.behalf.message }
                    error={ errors && errors.behalf ? true : false }
                    onChange={(event)=>{
                      if(event.target.value){
                        setCheckBehalf(event.target.value)
                      }
              ...
              <Controller 
                ...
                name="companyName"
                rules={{
                  required : { value : checkBehalf === "company", message : "กรุณาเลือกประเภท"},
                }}
                render={({field})=>(
                  <StyledTextFieldTheme
                    {...field}
